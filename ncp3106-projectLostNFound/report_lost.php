...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Validate input
    if (
        empty($_POST['title']) || empty($_POST['category_id']) || empty($_POST['date_lost']) ||
        ...
        if (empty($error)) {
            ...
            if ($stmt->execute()) {
                ...
                $potentialMatches = findPotentialMatches($lostItem);

                if (empty($potentialMatches)) {
                    $success = 'Your lost item has been reported successfully!';
                }
            } else {
                $error = 'Failed to report lost item: ' . $conn->error;
            }
        }
    }
}
    ...
    <div class="col-md-8 mx-auto">
        <?php if (!empty($potentialMatches)): ?>
            <div class="card shadow-sm mb-4">
                ...
                <div class="card-body">
                    <p>We found some items that might match what you lost. Please check if any of these are yours:</p>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a href="found_item.php?id=<?php echo $match['id']; ?>" class="btn btn-sm btn-primary">View Details</a>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; ?>
                ...
                <form method="post" action="" enctype="multipart/form-data" class="needs-validation" novalidate>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" class="form-control date-picker" id="date_lost" name="date_lost" max="<?php echo date('Y-m-d'); ?>" required>
                            <div class="invalid-feedback">Please select the date when the item was lost</div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="invalid-feedback">Please provide the location where the item was lost</div>
                        </div>
                    </div>
