...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // ✅ Check if email ends with @ue.edu.ph
    if (!preg_match('/@ue\.edu\.ph$/i', $userData['email'])) {
        $error = "❌ This is not a valid UE email. Please use your @ue.edu.ph account.";
    } else {
                            ...
                            <select class="form-select" id="department" name="department" required>
                                ...
                                <?php foreach ($departments as $department): ?>
                                    <option value="<?php echo $department['id']; ?>">
                                        <?php echo htmlspecialchars($department['name']); ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
