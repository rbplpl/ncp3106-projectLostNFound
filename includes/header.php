...
<head>
    <link rel="icon" type="image/png" href="/assets/images/ue_logo.png" />
    <link rel="stylesheet" href="/assets/css/ue-theme.css" />
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm sticky-top">
        <div class="container">
            <a class="navbar-brand fw-bold" href="index.php" style="color: #C8102E;">
                LostLink
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo $current_page == 'search.php?type=lost' ? 'active' : ''; ?>"
                            href="search.php?type=lost">
                            <i class="fas fa-search me-1"></i> Lost Items
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo $current_page == 'search.php?type=found' ? 'active' : ''; ?>"
                            href="search.php?type=found">
                            <i class="fas fa-hand-holding me-1"></i> Found Items
                        </a>
                    </li>
                    <?php if (isLoggedIn()): ?>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle <?php echo ($current_page == 'report_lost.php' || $current_page == 'report_found.php') ? 'active' : ''; ?>"
                    ...
                    <?php else: ?>
                        <li class="nav-item">
                            <a class="nav-link <?php echo $current_page == 'report_item.php' ? 'active' : ''; ?>"
                                href="report_item.php">
                                <i class="fas fa-plus-circle me-1"></i> Report Item
                            </a>
                        </li>
                    <?php endif; ?>
                ...
                <ul class="navbar-nav ms-auto">
                    <?php if (isLoggedIn()): ?>
                        <li class="nav-item">
                            <a class="nav-link <?php echo $current_page == 'my_reports.php' ? 'active' : ''; ?>"
                                href="my_reports.php">
