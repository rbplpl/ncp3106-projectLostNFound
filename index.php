...
<section
    style="background-color: #C8102E; color: #fff; text-align: center; padding: 5rem 0; border-radius: 0.5rem; box-shadow: 0 4px 10px rgba(0,0,0,0.1); margin-bottom: 3rem;">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <h1 class="display-4 fw-bold mb-3">UE Lost and Found | University of the East</h1>
                <p class="lead mb-4">Lost and Found Management System for University of the East Campus Community</p>
                ...
                <a href="lost_item.php?date=week" class="text-decoration-none">
                    <div class="card shadow-sm h-100">
                        <div class="card-body text-center">
                            ...
                            <h2 class="display-4 text-primary"><?php echo $stats['lost_week'] + $stats['found_week']; ?>
                            </h2>
                    ...
                    <div class="col-md-6 col-lg-4 mb-4">
                        <div class="card item-card h-100 shadow-sm hover-shadow">
                            <div class="position-absolute top-0 end-0 m-2">
                                <span
                                    class="badge bg-<?php echo $item['type'] === 'lost' ? 'danger' : 'success'; ?> rounded-pill px-3 py-2">
                                    <i
                                        class="fas <?php echo $item['type'] === 'lost' ? 'fa-search' : 'fa-hand-holding'; ?> me-1"></i>
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    <?php echo substr(htmlspecialchars($item['description']), 0, 100) . (strlen($item['description']) > 100 ? '...' : ''); ?>
                                </p>
                            </div>
                            <div class="card-footer bg-white border-0">
                                <a href="<?php echo $item['type']; ?>_item.php?id=<?php echo $item['id']; ?>"
                ...
                <div class="card shadow-sm">
                    <div class="card-header bg-white">
                        <ul class="nav nav-tabs card-header-tabs" id="activityTabs" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="lost-tab" data-bs-toggle="tab" data-bs-target="#lost"
                                    type="button" role="tab" aria-controls="lost" aria-selected="false">Lost
                                    Items</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="found-tab" data-bs-toggle="tab" data-bs-target="#found"
                                    type="button" role="tab" aria-controls="found" aria-selected="false">Found
                                    Items</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="matched-tab" data-bs-toggle="tab" data-bs-target="#matched"
                                    type="button" role="tab" aria-controls="matched"
                                            ...
                                            <div class="activity-item d-flex pb-3 mb-3 border-bottom">
                                                ...
                                                <div class="activity-content">
                                                    <div class="d-flex justify-content-between">
                                                        ...
                                                        <small
                                                            class="text-muted"><?php echo timeElapsed($activity['date']); ?></small>
                                                    </div>
                    ...
                    <div class="card-body">
                        <div class="how-it-works-step d-flex align-items-center mb-3">
                            ...
                            <div>
                                ...
                                <p class="small text-muted mb-0">Fill out a simple form with details about your lost
                                    item.</p>
                            </div>
                        </div>
                        <div class="how-it-works-step d-flex align-items-center mb-3">
                            ...
                            <div>
                                ...
                                <p class="small text-muted mb-0">Report items you've found to help reunite them with
                                    owners.</p>
                            </div>
                        </div>
                        <div class="how-it-works-step d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="small text-muted mb-0">Our system automatically matches lost and found items.
                                </p>
                            </div>
                        </div>
                    </div>
...
<section class="mb-5 text-white p-5 rounded shadow"
    style="background-color:#C8102E; background-image:linear-gradient(135deg, #C8102E, #9A0E24);">
    <div class="container">
        <div class="row align-items-center mb-4">
            <div class="col-md-6">
                <h2 class="fw-bold mb-3">How UE Lost and Found | University of the East Works</h2>
                <p class="lead">Our platform makes it easy to report, find, and recover lost items on campus.</p>
            </div>
            <div class="col-md-6 text-md-end">
                <a href="about.php" class="btn btn-light btn-lg text-danger fw-semibold">
                    Learn More About Us
                </a>
            </div>
        </div>
                ...
                <div class="card bg-white text-dark h-100 border-0 shadow-sm hover-lift">
                    <div class="card-body text-center p-4">
                        <div class="icon-circle mx-auto mb-4"
                            style="background-color:#f8d7da; color:#C8102E; width:70px; height:70px; border-radius:50%; display:flex; align-items:center; justify-content:center;">
                            <i class="fas fa-search fa-2x"></i>
                        </div>
                        <h4 class="card-title">Report Lost Item</h4>
                        <p class="card-text">Lost something? Fill out a simple form with details about your lost item
                            including when and where you last saw it.</p>
            ...
            <div class="col-md-4">
                <div class="card bg-white text-dark h-100 border-0 shadow-sm hover-lift">
                    <div class="card-body text-center p-4">
                        ...
                        <p class="card-text">Found something? Report it with details and photos so we can help reunite
                            it with its rightful owner quickly.</p>
                        <a href="report_found.php" class="btn btn-outline-danger mt-3"
                            style="border-color:#C8102E; color:#C8102E;">
            ...
            <div class="col-md-4">
                <div class="card bg-white text-dark h-100 border-0 shadow-sm hover-lift">
                    <div class="card-body text-center p-4">
                        ...
                        <p class="card-text">Our intelligent system automatically matches lost and found items based on
                            descriptions, locations, and dates.</p>
                        <a href="search.php" class="btn btn-outline-danger mt-3"
                            style="border-color:#C8102E; color:#C8102E;">
        ...
        <div class="text-center mt-5">
            <p class="lead mb-0 fw-semibold">Join thousands of UE members who have successfully recovered their lost
                items!</p>
        </div>
    </div>
</section>
